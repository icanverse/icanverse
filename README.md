# Merhaba, Ben Cengiz Can Yılmaz 👋

Bilgisayar Mühendisliği alanında eğitimime devam ederken; coğunlukla bilgisayarlı görü, bilgisayar grafikleri, yüksek başarımlı hesaplama (HPC), otonom drone sistemleri mimarisi üzerine geliştirme yapıyorum. 
...
* **[Kıvılcım : Cuda Vision Engine](https://github.com/icanverse/CudaVisionEngine) 🛠️** `v1.0.0` `C++` `CUDA` `OpenCV`
...
* **[Fotoğraf Editör](https://github.com/icanverse/PhotoEditor) 🛸** `v0.0.5` `Java` `opencv` 
  * Android odaklı Java tabanlı fotoğraf düzenleme arka-uç çalışması.

* **[Matematiksel İfade Parserleyici](https://github.com/icanverse/MathExpressionParser) 🛸** `Geliştirme Aşamasında Bırakıldı` `Java` 
  * Java tabanlı ifade parserleyicisi.
---

### 📈 İstatistikler ve Topluluk

<p align="center">
  <img src="https://github-readme-stats.vercel.app/api?username=icanverse&show_icons=true&theme=radical" width="48%" alt="GitHub İstatistikleri" />
  <img src="https://github-readme-stats.vercel.app/api/top-langs/?username=icanverse&layout=compact&theme=radical" width="48%" alt="En Çok Kullanılan Diller" />
</p>

---

📫 **Bana Ulaşın:** [LinkedIn](www.linkedin.com/in/caan-yılmaz) | [E-posta](mailto:caann.mz@gmail.com)
